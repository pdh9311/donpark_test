...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/07/04 19:28:59 by donpark           #+#    #+#             */
/*   Updated: 2021/07/04 19:55:19 by donpark          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			pivot_condition_ba(t_stack **a, t_stack **b,
										t_tmp *tmp, int *buf);
void			pivot_condition_ab(t_stack **a, t_stack **b,
										t_tmp *tmp, int *buf);
...
void			sort_23_ba_fix_sub3(t_stack **dst, t_stack **src,
										int *buf, int *flag);
void			sort_23_ba_fix_sub2(t_stack **dst, t_stack **src,
										int *buf, int *flag);
void			sort_23_ba_fix_sub1(t_stack **dst, t_stack **src,
										int *buf, int *flag);
void			sort_23_ba_fix_sub(t_stack **dst, t_stack **src, int *buf);
void			sort_23_ba_fix(t_stack **dst, t_stack **src, int len, int *buf);
void			sort_23_ba_sub3(t_stack **dst, t_stack **src,
										int *buf, int *flag);
void			sort_23_ba_sub2(t_stack **dst, t_stack **src,
										int *buf, int *flag);
void			sort_23_ba_sub1(t_stack **dst, t_stack **src,
										int *buf, int *flag);
...
void			push_swap_sort_45_sub(t_stack **a, t_stack **b,
										int index, int *buf);
...
void			reverse_rotate_ba(t_stack **lst, t_tmp tmp,
										char stack, int *buf);
